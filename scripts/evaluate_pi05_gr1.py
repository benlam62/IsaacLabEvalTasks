...
from config.args import pi05ClosedLoopArguments
#args = tyro.cli(Gr00tN1ClosedLoopArguments)
args = tyro.cli(pi05ClosedLoopArguments)
...
if __name__ == "__main__":
    ...
    # Pi 0.5 model hosted in a local policy server
    pi05_policy = Pi05Policy(args)
    ...
    run_closed_loop_policy(
        ...
        args=args, simulation_app=simulation_app, env_cfg=env_cfg, policy=pi05_policy, evaluator=evaluator
    )
